...
- **多様なアウトプット:**
  ...
  3. **ワードクラウド:** SudachiPy による形態素解析に基づき頻出単語を可視化します。
...
### ステップ4: ストップワードのカスタマイズ

ワードクラウド生成では SudachiPy による形態素解析後にストップワードを除去します。不要な語を追加・削除したい場合は、`coding/survey_analysis_mvp/stopwords_ja.txt` を編集してください。
